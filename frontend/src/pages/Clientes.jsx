...
const Clientes = () => {
  ...
  const handleGuardar = async (e) => {
    ...
    // Preparamos el objeto mapeando 'nombre' a 'nombre_completo'
    const datosEnviar = {
    ...
    <MainLayout>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <button onClick={() => abrirModal(null)} className="bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-lg transition-colors flex items-center gap-2 px-4">
